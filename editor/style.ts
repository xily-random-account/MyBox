...
.myboxEditor .playback-volume-controls > :last-child {
	width: 5em;
	flex-grow: 1;
}
...
.myboxEditor .piano-button.pressed, .myboxEditor .drum-button.pressed {
...
.myboxEditor .copy-instrument {
	margin: 2px 0;
	flex-grow: 1;
}
.myboxEditor .copy-instrument::before {
	content: "";
	flex-shrink: 0;
	position: absolute;
	left: 0;
...
.myboxEditor .paste-instrument {
	margin: 2px 0;
	flex-grow: 1;
}
.myboxEditor .paste-instrument::before {
	content: "";
	flex-shrink: 0;
	position: absolute;
	left: 0;
...
.myboxEditor .envelopeEditor {
	display: flex;
	flex-direction: column;
}

.myboxEditor .envelope-row {
	display: flex;
	margin: 2px 0;
	gap: 2px;
}

.myboxEditor .add-envelope {
	width: var(--button-size);
}
.myboxEditor .add-envelope::before {
	content: "";
	position: absolute;
	width: var(--button-size);
	height: var(--button-size);
...
.myboxEditor .add-envelope:disabled {
	visibility: hidden;
}

.myboxEditor .effects-menu {
	width: var(--button-size);
	position: relative;
}
.myboxEditor .effects-menu::before {
	content: "";
	position: absolute;
	width: var(--button-size);
	height: var(--button-size);
...
.myboxEditor .zoomInButton, .myboxEditor .zoomOutButton {
	width: var(--button-size);
	position: absolute;
	right: 10px;
}
.myboxEditor .zoomInButton {
	top: 10px;
}
.myboxEditor .zoomOutButton {
	top: 50px;
}
.myboxEditor .zoomInButton::before {
	content: "";
	position: absolute;
	width: var(--button-size);
	height: var(--button-size);
...
.myboxEditor .zoomOutButton::before {
	content: "";
	position: absolute;
	width: var(--button-size);
	height: var(--button-size);
...
.myboxEditor .delete-envelope {
	width: var(--button-size);
	flex-shrink: 0;
	flex-grow: 0;
}
.myboxEditor .delete-envelope::before {
	content: "";
	position: absolute;
	width: var(--button-size);
	height: var(--button-size);
...
.myboxEditor .delete-envelope:disabled {
	visibility: hidden;
}
...
.myboxEditor .prompt label {
	cursor: pointer;
}

.myboxEditor .prompt.recordingSetupPrompt p {
	margin-top: 0.75em;
	margin-bottom: 0;
}

.myboxEditor .prompt.recordingSetupPrompt > label:not(:first-child):not(.cancelButton) {
	margin: 2px 0;
}

.myboxEditor .layout-option {
	display: flex;
	flex-direction: column;
	flex: 1;
	cursor: pointer;
...
.myboxEditor .layout-option input {
	display: none;
}

.myboxEditor .layout-option input:checked ~ * {
	color: ${ColorConfig.primaryText};
}
...
.myboxEditor button.recordButton::before {
	content: "";
	flex-shrink: 0;
	position: absolute;
	left: 0;
...
.myboxEditor button.stopButton::before {
	content: "";
	flex-shrink: 0;
	position: absolute;
	left: 0;
...
.myboxEditor button.playButton, .myboxEditor button.pauseButton, .myboxEditor button.recordButton, .myboxEditor button.stopButton, .myboxEditor button.okayButton, .myboxEditor button.exportButton {
	padding-left: var(--button-size);
}
.myboxEditor button.playButton, .myboxEditor button.pauseButton, .myboxEditor button.recordButton {
	grid-column-start: 1;
	grid-column-end: 3;
}
.myboxEditor button.stopButton {
	grid-column-start: 1;
	grid-column-end: 5;
}
.myboxEditor button.prevBarButton {
	grid-column-start: 3;
	grid-column-end: 4;
}
.myboxEditor button.nextBarButton {
	grid-column-start: 4;
	grid-column-end: 5;
}

.myboxEditor button.playButton.shrunk, .myboxEditor button.recordButton.shrunk {
	padding: 0;
}
.myboxEditor button.playButton.shrunk::before, .myboxEditor button.recordButton.shrunk::before {
	left: 50%;
	top: 50%;
	transform: translate(-50%, -50%);
}
.myboxEditor button.playButton.shrunk span, .myboxEditor button.recordButton.shrunk span {
	display: none;
}
.myboxEditor button.playButton.shrunk {
	grid-column-start: 1;
	grid-column-end: 2;
}
.myboxEditor button.recordButton.shrunk {
	grid-column-start: 2;
	grid-column-end: 3;
}
...
.myboxEditor .instrument-bar {
	display: flex;
	gap: 2px;
}

.myboxEditor .instrument-bar button {
	flex-grow: 1;
	min-width: 0;
	padding: 0;
	flex-basis: 0;
...
.myboxEditor .instrument-bar .remove-instrument, .myboxEditor .instrument-bar .add-instrument {
	max-width: var(--button-size);
}

.myboxEditor .instrument-bar > :not(:first-child) {
	border-top-left-radius: 0;
	border-bottom-left-radius: 0;
}

.myboxEditor .instrument-bar > :not(.last-button) {
	border-top-right-radius: 0;
	border-bottom-right-radius: 0;
}

.myboxEditor .instrument-bar .selected-instrument {
	background: var(--background-color-lit);
	color: ${ColorConfig.invertedText};
}

.myboxEditor .instrument-bar .deactivated {
	background: ${ColorConfig.editorBackground};
	color: var(--text-color-dim);
}

.myboxEditor .instrument-bar .deactivated.selected-instrument {
	background: var(--background-color-dim);
	color: ${ColorConfig.invertedText};
}

.myboxEditor .instrument-bar .remove-instrument::before {
	content: "";
	position: absolute;
	width: 100%;
	height: var(--button-size);
...
.myboxEditor .instrument-bar .add-instrument::before {
	content: "";
	position: absolute;
	width: 100%;
	height: var(--button-size);
...
.myboxEditor .channelRow {
	display: flex;
}

.myboxEditor .channelBox {
	display: flex;
	text-align: center;
	align-items: center;
	justify-content: center;
...
.myboxEditor .channelBoxLabel {
	font-size: 20px;
	font-family: sans-serif;
	font-weight: bold;
}

.myboxEditor .channelBoxLabel.smaller-digits {
	font-size: 18px;
}
...
.myboxEditor .selectRow, .myboxEditor .instrumentCopyPasteRow {
	margin: 2px 0;
	height: var(--button-size);
	display: flex;
	flex-direction: row;
...
.myboxEditor .selectRow > :last-child {
	width: 62.5%;
	flex-shrink: 0;
}
...
.myboxEditor .pitchShiftMarkerContainer {
	box-sizing: border-box;
	display: flex;
	height: 100%;
	left: 3px;
...
.myboxEditor .pitchShiftMarker {
	width: 0;
	height: 0;
	position: absolute;
}

.myboxEditor .pitchShiftMarker::before {
	content: "";
	width: 2px;
	height: 20px;
	transform: translate(-50%, -50%);
...
.myboxEditor progress::-webkit-progress-bar {
	background-color: ${ColorConfig.uiWidgetBackground};
	border-radius: 5px;
}
.myboxEditor progress::-webkit-progress-value {
	background-color: ${ColorConfig.loopAccent};
	border-radius: 5px;
}
.myboxEditor progress::-moz-progress-bar {
	background-color: ${ColorConfig.loopAccent};
	border-radius: 5px;
}
